...
const STRANDED_ACCOUNTS: string[] = [
  // Consolidated 5 from createAccount scan (full data + create sigs + pools in recover-stranded-dlmm-rent.ts)
  "4PXeYHXhbU1RPUgHhQTEE2sMxDxELazCvGmzNZdYf4Fo", // Jun 23 NYKZsVV3... (MMG? width 140) create QRECnXor...
  "67jgEFj6HyQrRYpJGVDx8N94q6nmnDYmwNCBe5tyW9bz", // Jun 19 F4azS6Pd... create n4dcNbmM...
  "EHsvgQMWqZ26dKux8kreRC2tS14iZKyVFDDsuowE8nut", // Jun 19 8EuDUisJ... (Ranch-SOL) create 4JQb6p5X...
  "BUcSdNX2msJH3ZZkW7UVvCdP2ZKQpnAyDntxSxcU4LTz", // Jun 10 DYJCNWHc... (MMG-SOL) create 3fdcbvJ5...
  "DWoSDWPPbiKXigGGjuRPneRkJFvyy6BfU1qjf73kfzMz", // Jun 10 2rLXrMvG... (GO-SOL) create 3yv5UsMb...
];
